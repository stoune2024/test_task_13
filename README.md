...
При запущенной системе вы можете перейти на http://localhost:9090, чтобы попасть в GUI Prometheus. Там вы сможете просмотреть
интересующие вас метрики, например *videos_processed_total -> execute*.
